@props([
    ...
    'description' => 'Libera tu creatividad con nuestra suite completa de herramientas de diseño profesional y recursos.',
...
<div class="overflow-hidden rounded-3xl p-8 text-white shadow-xl relative" 
    ...
    <div class="relative z-10 flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
        <div class="space-y-4">
            ...
            <span class="inline-block rounded-xl bg-black/40 backdrop-blur-sm px-3 py-1 text-sm font-bold text-white border border-white/40 shadow-sm">
                Premium
            </span>
            
            <!-- Title with guaranteed white text and shadow -->
            <h2 class="text-3xl font-bold text-white drop-shadow-lg" style="color: #ffffff !important;">
                {{ $title }}
            </h2>
            
            <!-- Description with high contrast white text -->
            <p class="max-w-[600px] text-white drop-shadow-md leading-relaxed" style="color: #ffffff !important;">
                {{ $description }}
            </p>
            
            <div class="flex flex-wrap gap-3">
                <!-- Primary button with dark text on white background -->
                <button class="rounded-2xl bg-white px-6 py-2 font-semibold text-gray-900 hover:bg-zinc-100 transition-colors shadow-lg" 
                        style="background-color: #ffffff !important; color: #111827 !important;">
                    {{ $buttonPrimaryText }}
                </button>
                
                <!-- Secondary button with high contrast -->
                <button class="rounded-2xl border-2 border-white bg-black/40 backdrop-blur-sm px-6 py-2 font-semibold text-white hover:bg-black/50 transition-colors shadow-sm"
        ...
        <div class="hidden lg:block">
            <div class="relative h-40 w-40 rotate-slow">
                <div class="absolute inset-0 rounded-full bg-white/20 backdrop-blur-md border border-white/40 shadow-lg"></div>
