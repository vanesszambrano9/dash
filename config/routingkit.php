      ...
      'stubs' => [
        ...
        'filament_form' => [
            'controllers' => [
                [
                    'label' => 'Filament Table',
                    'default_name' => '{modelo}Form',
                    'extension' => '.php',
                    'stub_path' => base_path('routingkit/Stubs/filamentform/filamentform.blade.php'),
                    'stub_type' => 'blade',
                    'rk_route' => true,
                    'rk_navigation' => true,
                    'views' => [
                        [
                            'extension' => '.blade.php',
                            'stub_path' => base_path('routingkit/Stubs/filamentform/filamentformview.blade.php'),
                            'stub_type' => 'blade'
                        ],
        ...
        'livewire_component' => [
            'controllers' => [
                [
                    'default_name' => "ContactoForm",
                    'extension' => '',
                    'stub_path' => base_path('routingkit/Stubs/livewire/livewirecontroller.blade.php'),
                    'stub_type' => 'blade',
                    'rk_route' => true,
                    'rk_navigation' => true,
                    'views' => [
                        ...
                        [
                            'extension' => '.blade.php',
                            'stub_path' => base_path('routingkit/Stubs/livewire/livewireview.blade.php'),
                            'stub_type' => 'blade'
                        ],
